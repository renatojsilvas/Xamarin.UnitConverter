...
namespace UnitConverter
{
    ...
    {
        public (bool Success, string Message, Value Value) ConvertUnit(double value, string source, string destination)
        {
            ...
            return (true, string.Empty, new Value(convertedValue, destinationUnit.Symbol));
        }
